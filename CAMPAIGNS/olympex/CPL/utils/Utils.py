...
def ER2CPL(Hfile):
    """Reads the CPL data in hdf5 format and returns necessary atb datas in pandas dataframe

    Args:
        Hfile (string): s3 path of the input hdf5 data.

    Returns:
        Dataframe: pandas dataframe consisting of necessary atb data columns.
    """    
    ...
    # processing necessary data cols into dataframe.
    CPL = pd.DataFrame()
