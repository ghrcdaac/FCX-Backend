...
class Reader():
    """Reader that reads all data from a set of CF Radar Files.
    """
    ...
    def _read_radar(self):
        ...
        if filename.endswith('.gz'):
            with gzip_open(filename, 'rb') as unzipped_file:
                open("temp.cf", "wb").write(unzipped_file.read())
                radar = cfradial.read_cfradial(
                    "temp.cf",
    ...
    def read_data(self):
        ...
        # sweep by sweep; 3 sweeps per rhi_a file (over ocean)
