...
def makeCZML(fdate):
    ...
    ############################################
    fileLIP = glob.glob("/Users/Indhuja/Downloads/goesr_plt_lip_20170508.txt")[0]
    ...
    print("1.After groupby>>>")
    print(df)
    df = df.reset_index(drop=True)
    print("2.After groupby>>>")
    print(df)
    ...
    filepath = "/Users/Indhuja/Desktop/tcsp/lip/LIP0805goesr.czml"
